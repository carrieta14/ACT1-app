...
@section('content')
    <div class="container py-5 text-center">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="fullName" class="form-control" placeholder="Nombre" value="{{ old('fullName') ??@$teacher->fullName}}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="phone" class="form-control" placeholder="Telefono" value="{{ old('phone') ??@$teacher->phone}}">
