    ...
    <div class="container py-5 text-center">
        ...
        <table class="table table-secondary">
            ...
            <tbody>
                ...
                <tr>
                    <th> <a href="<?php echo e(route('estudent.index')); ?>" class="btn btn-primary">Estudents</a></th>
                    <th><a href="<?php echo e(route('teacher.index')); ?>" class="btn btn-warning">Teachers</a></th>
                    <th><a href="<?php echo e(route('course.index')); ?>" class="btn btn-light">Courses</a></th>
                </tr>
            </tbody>
        </table>
...
<?php echo $__env->make('theme.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\list-crud\resources\views/welcome.blade.php ENDPATH**/ ?>